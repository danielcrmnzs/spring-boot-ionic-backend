...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.devcoi.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do curso Spring Boot",
				...
				"Versão 1.0",
				"https://github.com/danielcrmnzs",
				new Contact("Daniel Coimbra", "https://github.com/danielcrmnzs", "coimbradcrm.dev@gmail.com"),
